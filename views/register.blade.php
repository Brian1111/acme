    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <form id="registerform" name="registerform" class="form-horizontal"
          ...
          <div class="form-group">
            <label for="veify_password" class="col-sm-2 control-label">Verify Password</label>
            <div class="col-sm-10">
              <input type="password" class="form-control" id="veify_password" name="verify_password" placeholder="Verify Password">
            </div>
          </div>
